...
#define __VECTORS_H     1
    ...
    extern void PB1_isr(void);
    extern void PE24_isr(void);
    //默认中断服务例程
    ...
    #define VECTOR_067      uart3_isr     // 0x0000_010C 67    51     UART3            Single interrupt vector for UART status sources
    ...
    #define VECTOR_079      FTM1_isr//default_isr     // 0x0000_013C 79    63     FTM1 			 Single interrupt vector for all sources
    ...
    #define VECTOR_085      default_isr//pit1_isr//     // 0x0000_0154 85    69     PIT Channel 1
    ...
    #define VECTOR_104      PB1_isr// default_isr//    // 0x0000_01A0 104   88     Port control module Pin Detect (Port B)
    ...
    #define VECTOR_107      PE24_isr//default_isr     // 0x0000_01AC 107   91     Port control module Pin Detect (Port E)
